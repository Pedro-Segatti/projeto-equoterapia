...
CREATE TABLE PAIS (
	...
	PAI_ISO VARCHAR(4) NOT NULL UNIQUE, 
...
INSERT INTO ESTADO (EST_UF, EST_NOME, EST_ID_PAIS) VALUES
('AC', 'ACRE', 1),
('AL', 'ALAGOAS', 1),
('AM', 'AMAZONAS', 1),
('AP', 'AMAPÁ', 1),
...
PES_END_COMPL, PES_NACIONALIDADE, PES_ID_LOG) VALUES
  ('ADMINISTRADOR', '03805594046', '12345', 'F', '2003-02-13', '1', NULL, 'BR', '1'),
  ('RESPONSAVEL', '92660045020', NULL, 'M', '2000-01-01', '2', 'APTO 1', 'BR', '1'),
  ('FUNCIONARIO1', '50782722083', '12345', 'F', '1988-01-01', '3', NULL, 'BR', '1'),
  ('FUNCIONARIO2', '71806477050', NULL, 'M', '1986-01-01', '4', NULL, 'BR', '1'),
  ('PRATICANTE', '89564261040', NULL, 'F', '2019-09-15', '5', 'APTO 1', 'BR', '1'),
  ('MEDICO', '95852437093', NULL, 'M', '2000-01-01', '6', NULL, 'BR', '1');
...
INSERT INTO ATIVIDADE (ATV_DESCRICAO, ATV_DURACAO) VALUES
  ('SOLO', '30 MIN'),
  ('LIMPEZA DE COCHEIRA', '10 MIN'),
  ('LIMPEZA DE CASCO', '20 MIN'),
  ('ESCOVAÇÃO', '10 MIN');
