...
CREATE TABLE LOCAL_ATENDIMENTO (
	LOC_AT_ID INTEGER NOT NULL PRIMARY KEY AUTO_INCREMENT,
    LOC_AT_DESCRICAO VARCHAR(60) NOT NULL
);
...
CREATE TABLE FICHA_EVOL_LOCAL_ATEND (
	FXLA_ID INTEGER NOT NULL PRIMARY KEY AUTO_INCREMENT,
    FXLA_ID_LOC_AT INTEGER NOT NULL,
    FXLA_ID_FICHA INTEGER NOT NULL,
    CONSTRAINT FK_FXLA_LOC_AT FOREIGN KEY(FXLA_ID_LOC_AT) REFERENCES LOCAL_ATENDIMENTO(LOC_AT_ID),
    CONSTRAINT FK_FXLA_FICHA FOREIGN KEY(FXLA_ID_FICHA) REFERENCES FICHA_EVOLUCAO(EVOL_ID) ON UPDATE CASCADE ON DELETE CASCADE
);
