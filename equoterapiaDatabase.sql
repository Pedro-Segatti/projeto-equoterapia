...
CREATE TABLE CONFIGURACOES (
    ...
    CONF_EMAIL_PASSWORD BLOB,
    CONF_EMAIL_CORPO BLOB,
    CONF_IMAGE_LOGO LONGBLOB,
    CONF_IMAGE_LOADING LONGBLOB,
    CONF_IMAGE_LOGIN LONGBLOB,
    CONF_COR_PRINCIPAL VARCHAR(100),
...
INSERT INTO PAIS (PAI_ISO, PAI_NOME) VALUES
('AFG', 'AFEGANISTÃO'),
('ZAF', 'ÁFRICA DO SUL'),
('ALB', 'ALBÂNIA'),
('DEU', 'ALEMANHA'),
...
CREATE TABLE ESTADO (
    ...
    EST_ISO_PAIS VARCHAR(3) NOT NULL,
	CONSTRAINT FK_EST_PAIS FOREIGN KEY(EST_ISO_PAIS) REFERENCES PAIS(PAI_ISO)
);

-- DROP TABLE ESTADO;

INSERT INTO ESTADO (EST_UF, EST_NOME, EST_ISO_PAIS) VALUES
('AC', 'ACRE', 'BRA'),
('AL', 'ALAGOAS', 'BRA'),
('AM', 'AMAZONAS', 'BRA'),
('AP', 'AMAPÁ', 'BRA'),
...
INSERT INTO CIDADE (CID_ID, CID_NOME, CID_ID_EST) VALUES
...
INSERT INTO BAIRRO (BAR_NOME, BAR_ID_CID) VALUES
  ('BELA VISTA', '430700');
...
INSERT INTO LOGRADOURO (LOG_DESCRICAO, LOG_CEP, LOG_ID_BAI) VALUES
  ('RUA ERNESTO RIGONI', '99704054', '1');

CREATE TABLE PESSOA (
	PES_ID INTEGER NOT NULL PRIMARY KEY AUTO_INCREMENT, 
	PES_NOME VARCHAR(60) NOT NULL, 
	PES_CPF VARCHAR(11) NOT NULL UNIQUE,
    PES_EMAIL1 VARCHAR(100),
	...
	PES_NACIONALIDADE VARCHAR(3) NOT NULL,
    PES_ID_LOG INTEGER NOT NULL,
    PES_FOTO LONGBLOB,
	CONSTRAINT FK_PES_LOGRADOURO FOREIGN KEY(PES_ID_LOG) REFERENCES LOGRADOURO(LOG_ID),
    CONSTRAINT FK_PES_NACIONALIDADE FOREIGN KEY(PES_NACIONALIDADE) REFERENCES PAIS(PAI_ISO)
);

INSERT INTO PESSOA (PES_NOME, PES_CPF, PES_LOGIN_PASSWORD, PES_SEXO, PES_DATA_NASC, PES_END_NUM,
PES_END_COMPL, PES_NACIONALIDADE, PES_ID_LOG) VALUES
  ('ADMINISTRADOR', '03805594046', '81dc9bdb52d04dc20036dbd8313ed055', 'F', '2003-02-13', '1', NULL, 'BRA', '1'),
  ('RESPONSAVEL', '92660045020', '81dc9bdb52d04dc20036dbd8313ed055', 'M', '2000-01-01', '2', 'APTO 1', 'BRA', '1'),
  ('FUNCIONARIO1', '50782722083', '81dc9bdb52d04dc20036dbd8313ed055', 'F', '1988-01-01', '3', NULL, 'BRA', '1'),
  ('FUNCIONARIO2', '71806477050', '81dc9bdb52d04dc20036dbd8313ed055', 'M', '1986-01-01', '4', NULL, 'BRA', '1'),
  ('PRATICANTE', '89564261040', '81dc9bdb52d04dc20036dbd8313ed055', 'F', '2019-09-15', '5', 'APTO 1', 'BRA', '1'),
  ('MEDICO', '95852437093', '81dc9bdb52d04dc20036dbd8313ed055', 'M', '2000-01-01', '6', NULL, 'BRA', '1');
...
INSERT INTO TELEFONE (TEL_NUMERO, TEL_ID_PESSOA) VALUES
  ('(54)99953-0644', '3'),
  ('54996200641', '3'); 
...
CREATE TABLE RESPONSAVEL (
    ...
    RESP_ID_PESSOA INTEGER NOT NULL UNIQUE,
	CONSTRAINT FK_RESP_PESSOA FOREIGN KEY(RESP_ID_PESSOA) REFERENCES PESSOA(PES_ID)
);

INSERT INTO RESPONSAVEL (RESP_PROFISSAO, RESP_ID_PESSOA) VALUES
  ('PROFESSOR', '2');
...
INSERT INTO CARGO (CAR_DESCRICAO) VALUES
  ('MEDIADOR'),
  ('GUIA'),
  ('ESTAGIÁRIO'),
  ('FISIOTERAPEUTA'),
...
INSERT INTO FUNCIONARIO (FUNC_DATA_ADMISSAO, FUNC_DATA_DESLIGAMENTO, FUNC_PIS, FUNC_CNH,
FUNC_ID_PESSOA) VALUES
  ('2015-01-01', NULL, '123456789', '987654321', '3'),
  ('2010-01-01', '2011-08-05', '4957934759375', '3847239574', '4');
...
INSERT INTO FUNCIONARIO_CARGO (FXC_ID_FUNC, FXC_ID_CARGO) VALUES
  ('1', '1'),
  ('2', '2');
...
CREATE TABLE PRATICANTE (
    ...
    PRAT_ALTURA INTEGER NOT NULL,
    PRAT_PESO INTEGER NOT NULL,
    CONSTRAINT FK_PRAT_PESSOA FOREIGN KEY(PRAT_ID_PESSOA) REFERENCES PESSOA(PES_ID)
);

INSERT INTO PRATICANTE (PRAT_ID_PESSOA, PRAT_ALTURA, PRAT_PESO) VALUES
  ('5', '1.50', '1.42');
...
CREATE TABLE PRATICANTE_RESPONSAVEL(
    ...
    PXR_TIPO_RESP VARCHAR(1) NOT NULL,
...
ALTER TABLE PRATICANTE_RESPONSAVEL ADD UNIQUE INDEX (PXR_ID_PRAT, PXR_ID_RESP);

INSERT INTO PRATICANTE_RESPONSAVEL (PXR_ID_PRAT, PXR_ID_RESP, PXR_TIPO_RESP) VALUES
  ('1', '1', 'M');

CREATE TABLE MEDICO (
	MED_ID INTEGER NOT NULL PRIMARY KEY AUTO_INCREMENT,
    MED_ID_PESSOA INTEGER NOT NULL UNIQUE,
    CONSTRAINT FK_MED_PESSOA FOREIGN KEY(MED_ID_PESSOA) REFERENCES PESSOA(PES_ID)
);

INSERT INTO MEDICO (MED_ID_PESSOA) VALUES
  ('6');

CREATE TABLE AVAL_SOCIOECON (
	ASE_ID INTEGER NOT NULL PRIMARY KEY AUTO_INCREMENT, 
	ASE_DATA DATE NOT NULL,
...
CREATE TABLE DOCUMENTOS (
    ...
    DOC_DESCRICAO VARCHAR(100) NOT NULL,
	DOC_DOCUMENTO LONGBLOB NOT NULL,
...
CREATE TABLE AVAL_FISIOTER (
	...
	AFT_DATA DATE NOT NULL,
    AFT_ID_PRATICANTE INTEGER NOT NULL, 
    AFT_SIN_VIT INTEGER,
    AFT_ID_FUNCIONARIO INTEGER NOT NULL,
	AFT_QUEIXA BLOB, -- QUEIXA PRINCIPAL
	AFT_DIAG_CLIN BLOB, -- DIAGNÓSTICO CLINICO
    AFT_MEDICAMENTOS BLOB,
	AFT_DIAG_FISIO_FUNC BLOB, -- FISIODIAGNÓSTICO
	AFT_ANAMNESE BLOB, 
	AFT_ROT_TERAPIA BLOB, -- ROTINA DIARIA
	AFT_EXAME_FIS BLOB, -- EXAME FISICO
	AFT_DES_MOTO_NEURO_CCERV VARCHAR(20), -- DESENVOLVIMENTO MOTOR E NEURO CONTROLE CERVICAL
    AFT_DES_MOTO_NEURO_CTRONC VARCHAR(20), -- CONTROLE DE TRONCO
    AFT_DES_MOTO_NEURO_ROLOU VARCHAR(20), -- ROLOU
    AFT_DES_MOTO_NEURO_ENGAT VARCHAR(20), -- ENGATINHOU
    AFT_DES_MOTO_NEURO_AND VARCHAR(20), -- ANDOU
    AFT_DES_MOTO_NEURO_OBS BLOB, -- DESENVOLVIMETNO MOTOR E NEURO OBS
	AFT_REF_PRIM_TEND BLOB, -- REFLEXOS PRIMITIVOS E TENDINEOS
	AFT_SENSE_TATIL BOOLEAN, -- SENSIBILIDADE TATIL
	AFT_SENSE_DOLO BOOLEAN, -- SENSIBILIDADE DOLOROSA
	AFT_SENSE_TERM BOOLEAN, -- SENSIBILIDADE TERMICA 
	AFT_SENSE_OBS BLOB, -- SENSIBILIDADE OBS
    AFT_EQUI_EST_DIN BLOB, -- EQUILIBRIO ESTATICO DINAMICO
	AFT_AMOTO_HIPE BOOLEAN, -- HIPERTONIA
    AFT_AMOTO_HIPO BOOLEAN, -- HIPOTONIA
    AFT_AMOTO_COR BOOLEAN, -- COREIA 
	AFT_AMOTO_ATE BOOLEAN, -- ATETOSE 
    AFT_AMOTO_CONT_ESP BOOLEAN, -- CONTRATURA ESPASTICIDADE
	AFT_AMOTO_DEF_ATX BOOLEAN, -- DEFORMIDADE ATAXIA 
	AFT_AMOTO_CLONUS BOOLEAN, -- CLONUS
	AFT_AMOTO_OBS BLOB, -- ALTERAÇÃO MOTORA OBS
	AFT_MAR_LOC_ATU BLOB, -- MARCHA LOCOMOÇÃO ATUAL
	AFT_AVAL_POST_SOL_CAV BLOB,
	AFT_MTR_ALC_OBJ VARCHAR(2), -- 	MOTRICIDADE ALCANCE DE OBJETOS
	AFT_MTR_ALIMEN VARCHAR(2), -- ALIMENTA-SE
	AFT_MTR_PREEN_OBJ VARCHAR(2), -- PREENSAO DE OBJETOS
	AFT_MTR_HIGIENI VARCHAR(2), -- HIGIENIZA-SE
	AFT_MTR_USO_BIMANUAL VARCHAR(2), -- USO BIMANUAL
	AFT_MTR_NEG_MEMBRO VARCHAR(2), -- NEGLIGENCIA DE MEMBRO
	AFT_MTR_VESTE_SOZ VARCHAR(2), -- VESTE-SE
	AFT_MTR_CONT_ESFINCT VARCHAR(2), -- CONTROLE DE ESFINCTERS
    AFT_MTR_COMENT BLOB, -- COMENTARIO
	AFT_FMUSC_MMSS VARCHAR(2), -- FORÇA MUSCULAR MMSS
	AFT_FMUSC_MMII VARCHAR(2), -- FORÇA MUSCULAR MMII
	AFT_FMUSC_TRONCO VARCHAR(2), -- FORÇA MUSCULAR TRONCO
	AFT_FMUSC_OBS BLOB, -- FORÇA MUSCULAR OBS
	AFT_CMOTO_EST_OBS BLOB, -- COORDENAÇAO MOTORA ESTATICA 
	AFT_CMOTO_DIN_OBS BLOB, -- COORDENAÇAO MOTORA DINAMICA
	AFT_PREEN_PALMAR BOOLEAN, -- PREENSAO PALMAR
	AFT_PREEN_PINCA BOOLEAN, -- PREENSAO PINÇA
    AFT_PREEN_OBS BLOB,
	AFT_MOV_PASSIVA VARCHAR(20), -- MOVIMENTACAO PASSIVA
	AFT_MOV_RESPIRA VARCHAR(20), -- MOV RESPIRACAO 
	AFT_MOV_DEGLUTI VARCHAR(20), -- MOV DEGLUTINACAO 
	AFT_MOV_MASTIG VARCHAR(20), -- MOV MATIGAÇAO 
	AFT_MOV_CONT_ESFINCT VARCHAR(20), -- MOV CONTROLE ESFINCTER
	AFT_QUAD_COGNITIVO BLOB, -- QUADRO COGNITIVO FALA
	AFT_SIST_RESP BLOB, -- SISTEMA RESPIRATORIO
	AFT_SIST_CIRC BLOB, -- SISTEMA CIRCULATORIO
	AFT_PARECER_FISIO BLOB, -- PARECER FISIOTERAPICO
    AFT_ID_MEDICO INTEGER NOT NULL,
    ...
    CONSTRAINT FK_AFT_MEDICO FOREIGN KEY(AFT_ID_MEDICO) REFERENCES MEDICO(MED_ID) ON UPDATE CASCADE
);

CREATE TABLE ANEXO_AFT (
	AAFT_ID INTEGER NOT NULL PRIMARY KEY AUTO_INCREMENT,
    AAFT_DESCRICAO VARCHAR(100) NOT NULL,
    AAFT_EXAM_COMP LONGBLOB NOT NULL, -- EXAMES COMPLEMENTARES ANEXOS
    AAFT_ID_AVAL_FISIO INTEGER NOT NULL,
    CONSTRAINT FK_AAFT_AVAL_FISIO FOREIGN KEY (AAFT_ID_AVAL_FISIO) REFERENCES AVAL_FISIOTER(AFT_ID) ON UPDATE CASCADE ON DELETE CASCADE
);

CREATE TABLE FICHA_ANAMNESE (
	AMN_ID INTEGER NOT NULL PRIMARY KEY AUTO_INCREMENT,
    AMN_DATA DATE NOT NULL,
    ...
    AMN_DIF_VER BOOLEAN,
    AMN_DIF_OUVIR BOOLEAN,
    AMN_ASPCT_EMOC VARCHAR(1),
    AMN_ASPCT_EMOC_OBS BLOB,
    AMN_PAIS_VEEM BLOB,
    AMN_INTERAGE BOOLEAN,
    AMN_INTERAGE_OBS BLOB,
    AMN_FICAR_SOZ VARCHAR(20),
    AMN_BRINCAR_SOZ VARCHAR(20),
    AMN_BRINCAR_OBS BLOB,
    AMN_ANIMAIS_ESTIM BOOLEAN,
    AMN_INTERAGE_ANIMAIS BOOLEAN,
    AMN_ANI_ESPCFC VARCHAR(20),
    AMN_ADAPTA_LUGAR BOOLEAN,
    AMN_ATENDE_INTERV BOOLEAN,
    AMN_ATENDE_ORIENT BOOLEAN,
    AMN_CHORO_FACIL BOOLEAN,
    AMN_CHORO_OBS BLOB,
    AMN_REC_AUXILIO BOOLEAN,
    AMN_REC_AUX_OBS BLOB,
    AMN_RESIST_TOQUE BOOLEAN,
    AMN_BRONQUITE BOOLEAN,
    AMN_ALERGIAS BOOLEAN,
    AMN_ASMA BOOLEAN,
    AMN_CONVULSAO BOOLEAN,
    AMN_VIROSE BOOLEAN,
    AMN_INTERNACOES BLOB,
    AMN_OUT_DOENCAS BLOB,
    AMN_TRAT_REALIZADOS BLOB,
    AMN_TRAT_ATUAL BOOLEAN,
    AMN_TRAT_ATUAL_OBS BLOB,
    AMN_MEDICACAO BOOLEAN,
    AMN_MED_OBS BLOB,
    AMN_CONSIDERACOES BLOB,
...
CREATE TABLE ANEXO_AMN (
	AAMN_ID INTEGER NOT NULL PRIMARY KEY AUTO_INCREMENT,
    AAMN_DESCRICAO VARCHAR(100) NOT NULL,
    AAMN_EXAM_COMP LONGBLOB NOT NULL, -- EXAMES COMPLEMENTARES ANEXOS
    AAMN_ID_FICHA_ANAMNESE INTEGER NOT NULL,
    CONSTRAINT FK_AAMN_FICHA_ANAMNESE FOREIGN KEY (AAMN_ID_FICHA_ANAMNESE) REFERENCES FICHA_ANAMNESE(AMN_ID) ON UPDATE CASCADE ON DELETE CASCADE
);
...
INSERT INTO PICADEIRO (PIC_DESCRICAO) VALUES
  ('COBERTO DE AREIA'),
  ('ABERTO DE AREIA PEQUENO'),
  ('ABERTO DE AREIA GRANDE'),
  ('ESTRADA DE CHAO'),
  ('GRAMA'),
  ('TRILHA'),
  ('LAVOURA');
...
INSERT INTO ANIMAL (ANI_IDADE, ANI_NOME, ANI_PORTE, ANI_COMPORTAMENTO, ANI_ANDADURA) VALUES
  (NULL, 'FRITZ', 'G', 'CALMO', 'LEVIANA'),
  ('8', 'NANQUIM', 'GG', 'CALMO', 'LEVIANA'),
  (NULL, 'CHIQUITO', 'M', NULL, NULL),
  ('11', 'ROSILHO', 'G', 'AGITADO', 'PESADA'),
  (NULL, 'INDIO', 'G', 'CALMO', 'MEDIANA'),
  (NULL, 'PELEADOR', 'G', NULL, NULL),
  (NULL, 'GATEADO', 'P', 'CALMO', 'LEVIANA'),
  (NULL, 'CORRALERO', 'G', NULL, NULL);
...
INSERT INTO ATIVIDADE (ATV_DESCRICAO, ATV_DURACAO) VALUES
  ('SOLO', 30),
  ('LIMPEZA DE COCHEIRA', 10),
  ('LIMPEZA DE CASCO', 20),
  ('ESCOVAÇÃO', 10);
...
INSERT INTO MATERIAL (MAT_DESCRICAO) VALUES
  ('MANTA'),
  ('MANTA GEL'),
  ('CILHÃO PEQUENO'),
  ('CILHÃO GRANDE'),
...
CREATE TABLE MONTARIA (
	MONT_ID INTEGER NOT NULL PRIMARY KEY AUTO_INCREMENT,
    MONT_DESCRICAO VARCHAR(50) NOT NULL
);

INSERT INTO MONTARIA (MONT_DESCRICAO) VALUES
  ('RAMPA'),
  ('ESCADINHA'),
  ('SOLO'),
  ('COM AUXÍLIO'),
...
CREATE TABLE FICHA_EVOLUCAO(
    ...
    EVOL_DATA DATE NOT NULL,
    EVOL_CLIMA VARCHAR(1) NOT NULL,
    EVOL_HUMOR VARCHAR(20),
    EVOL_ATENC VARCHAR(20),
    EVOL_AUTON VARCHAR(20),
    EVOL_ESTEREOTIPIA BLOB,
    EVOL_POST VARCHAR(20),
    EVOL_PROG BLOB,
    EVOL_REG BLOB,
    EVOL_OBS BLOB,
    EVOL_REC_LUDICOS BOOLEAN,
    EVOL_QUAIS_REC_LUD BLOB,
    EVOL_OBS_REC_LUD BLOB,
    EVOL_DECUBITO NVARCHAR(1),
    EVOL_COMP_ANI NVARCHAR(30),
    EVOL_AND_ANI NVARCHAR(30),
    EVOL_ID_MONT INTEGER NOT NULL,
    EVOL_ID_PRAT INTEGER NOT NULL,
    CONSTRAINT FK_EVOL_MONT FOREIGN KEY(EVOL_ID_MONT) REFERENCES MONTARIA(MONT_ID),
    CONSTRAINT FK_EVOL_PRAT FOREIGN KEY(EVOL_ID_PRAT) REFERENCES PRATICANTE(PRAT_ID)
);
...
CREATE TABLE AGENDAMENTO(
    ...
    AGD_ID_PRATICANTE INTEGER NOT NULL,
